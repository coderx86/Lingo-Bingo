        ...
        <div className="hero min-h-screen">
          <div className="hero-content flex-col lg:flex-row-reverse">
            <div className="text-center lg:text-left">
              ...
              <p className="py-6">
                Access your personalized learning journey and continue expanding
                your language skills with Lingo Bingo. Let's pick up where you
                left off!
              </p>
            </div>
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
              <form className="card-body" onSubmit={handleSubmit}>
                ...
                <div>
                  <NavLink to="/reset-password">
                    <p className="text-sm text-red-700">Forgot Password?</p>
                  </NavLink>
                </div>
              ...
              <div className="mb-6">
                <p className="text-center">
                  Not Registered?
                  <NavLink
                    className="text-green-800 text-semibold"
                    to="/signup"
                  >
                    {" "}
                    Create an account
